...
import com.pedometer.asamapps.preferences.FontAwesomeViewHolder;
...
public class SettingsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        if (tabName.equals(context.getString(R.string.help)))
        {
            holder.itemIcon.setIcon(context.getString(R.string.help_icon));
        }
        ...
        else if(tabName.equals(context.getString(R.string.visit_website))){
            holder.itemIcon.setIcon(context.getString(R.string.web_icon));
        }
        return view;
    }
}
