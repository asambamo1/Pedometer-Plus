...
public class PedometerSettings {
    ...
    /*public int getViewOption() {
        String p = mSettings.getString("view", "false");
        return
                p.equals("false") ? M_NONE : (
                                        0);
    }*/
    ...
    public void saveServiceRunningWithTimestamp(boolean running) {
        ...
        editor.putLong("last_seen", PedometerUtils.currentTimeInMillis());
        editor.commit();
    }
    ...
    public boolean isNewStart() {
        ...
        return mSettings.getLong("last_seen", 0) < PedometerUtils.currentTimeInMillis() - 1000*60*10;
    }
